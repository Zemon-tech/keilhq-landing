...
const testimonials = [
  ...
  {
    quote: "The AI ranking and task clarity features save me significant triage time every morning.",
    author: "Product Manager, tech team",
  },
  {
    quote: "Having meeting transcripts automatically generate actionable tasks in our Motion docs is a game changer.",
    author: "Agency Founder, design studio",
  },
];
                    ...
                    <form className="flex flex-col gap-4 mt-2">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <Input
                          id="demo-tools"
                          type="text"
                          placeholder="e.g. Slack, Asana, Notion, Otter"
                          className="bg-background/50"
                        />
                      </div>
                      <Button
