...
/**
 * Monochrome platform glyphs for press cards. Brand marks stay
 * currentColor — no multi-color logo soup, no accent per platform.
 */
export function PlatformIcon({
  ...
  switch ((platform || "news").toLowerCase()) {
    case "x":
      return (
    ...
    case "podcast":
      return <Podcast className={cls} aria-hidden="true" />;
    case "news":
    default:
