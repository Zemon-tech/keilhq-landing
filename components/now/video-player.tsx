...
export const VideoPlayer = ({ src, poster }: { src: string; poster: string }) => {
  ...
  return (
    <div className="relative w-full rounded-md overflow-hidden bg-black aspect-[16/9] group/player border border-border select-none">
      ...
      {/* Control Overlay */}
      <div className="absolute bottom-0 left-0 right-0 p-4 bg-black/70 flex flex-col gap-2 transition-opacity duration-300 opacity-0 group-hover/player:opacity-100">
