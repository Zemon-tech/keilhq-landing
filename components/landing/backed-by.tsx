        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 md:gap-4">
          ...
          <div className="flex flex-wrap items-center justify-start md:justify-end gap-x-10 gap-y-5 w-full">
            ...
            <div className="flex items-center gap-2 group cursor-default">
              <svg viewBox="0 0 24 24" className="size-4 text-zinc-400 group-hover:text-zinc-700 transition-colors" fill="currentColor">
              ...
              <span className="text-sm font-semibold text-zinc-500 group-hover:text-zinc-900 transition-colors">Slack</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-default">
              ...
              <span className="text-sm font-semibold text-zinc-500 group-hover:text-zinc-900 transition-colors">GitHub</span>
            </div>

            {/* Google Calendar */}
            <div className="flex items-center gap-2 group cursor-default">
              <svg viewBox="0 0 24 24" className="size-4 text-zinc-400 group-hover:text-zinc-700 transition-colors" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
                <line x1="16" y1="2" x2="16" y2="6"/>
                <line x1="8" y1="2" x2="8" y2="6"/>
                <line x1="3" y1="10" x2="21" y2="10"/>
              </svg>
              <span className="text-sm font-semibold text-zinc-500 group-hover:text-zinc-900 transition-colors">Google Calendar</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-default">
              ...
              <span className="text-sm font-semibold text-zinc-500 group-hover:text-zinc-900 transition-colors">Notion</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-default">
              ...
              <span className="text-sm font-semibold text-zinc-500 group-hover:text-zinc-900 transition-colors">Linear</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-default">
              ...
              <span className="text-sm font-semibold text-zinc-500 group-hover:text-zinc-900 transition-colors">Jira</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-default">
              ...
              <span className="text-sm font-semibold text-zinc-500 group-hover:text-zinc-900 transition-colors">Google Gemini</span>
            </div>

            {/* +50 more */}
            <div className="flex items-center gap-1.5 cursor-default">
              <span className="text-sm font-semibold text-zinc-400">+50 more</span>
            </div>
