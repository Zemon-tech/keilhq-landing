export function BackedBy() {
  return (
    <section className="w-full min-h-screen bg-background flex items-center justify-center py-16">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 md:gap-4">
          ...
          <div className="flex flex-wrap items-center justify-start md:justify-end gap-x-10 gap-y-5 w-full">
            ...
            <div className="flex items-center gap-2 group cursor-default">
              ...
              <span className="text-[13px] font-medium text-muted-foreground group-hover:text-foreground transition-colors duration-150">Slack</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-default">
              ...
              <span className="text-[13px] font-medium text-muted-foreground group-hover:text-foreground transition-colors duration-150">GitHub</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-default">
              ...
              <span className="text-[13px] font-medium text-muted-foreground group-hover:text-foreground transition-colors duration-150">Google Calendar</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-default">
              ...
              <span className="text-[13px] font-medium text-muted-foreground group-hover:text-foreground transition-colors duration-150">Notion</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-default">
              ...
              <span className="text-[13px] font-medium text-muted-foreground group-hover:text-foreground transition-colors duration-150">Linear</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-default">
              ...
              <span className="text-[13px] font-medium text-muted-foreground group-hover:text-foreground transition-colors duration-150">Jira</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-default">
              ...
              <span className="text-[13px] font-medium text-muted-foreground group-hover:text-foreground transition-colors duration-150">Google Gemini</span>
            </div>

            {/* +50 more */}
            <div className="flex items-center gap-1.5 cursor-default">
              <span className="text-[13px] font-medium text-muted-foreground/60">+50 more</span>
            </div>
