...
const viewsData: ViewItem[] = [
  {
    ...
    lightImage: "/mockups/light/task sidebar overview light.png",
    darkImage: "/mockups/dark/task sidebar dark.png",
  },
  {
    id: "calendar-view",
    title: "Calendar View",
    ...
    lightImage: "/mockups/light/task calendar view light.png",
    darkImage: "/mockups/dark/task calendar view dark.png",
  },
  {
    id: "list-view",
    title: "List View",
    ...
    lightImage: "/mockups/light/task list view light.png",
    darkImage: "/mockups/dark/task list view dark.png",
  },
  {
    id: "kanban-view",
    title: "Kanban View",
    ...
    lightImage: "/mockups/light/task kanban view light.png",
    darkImage: "/mockups/dark/task kanban view dark.png",
  },
  {
    id: "track-view",
    title: "Track View",
    summary: "Real-time progress monitoring, change audit logs, in-progress state tracking, and active execution status oversight.",
    lightImage: "/mockups/light/task track view light.png",
    darkImage: "/mockups/dark/task track view dark.png",
  },
];
