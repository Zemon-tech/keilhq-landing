...
export function Vision() {
  return (
    <section className="w-full bg-background py-6 px-4 sm:px-6 lg:px-8">
      ...
      */}
      <div className="relative w-full rounded-2xl overflow-hidden" style={{ height: "calc(100vh - 48px)" }}>
        ...
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <button className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 text-white text-sm font-medium hover:bg-white/30 transition-colors">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 px-4 py-3 flex items-center gap-3 bg-gradient-to-t from-black/60 to-transparent">
          ...
          <div className="flex-1 h-1 bg-white/30 rounded-full overflow-hidden">
            <div className="h-full bg-white rounded-full" style={{ width: "1.2%" }} />
          </div>
